...
public class OMDBTvShowDeserializer extends StdDeserializer<OmdbTvShowDTO> {

    private static final String MISSING_VALUE = "N/A";

    public OMDBTvShowDeserializer() {
        super(OmdbTvShowDTO.class);
    }

    public OMDBTvShowDeserializer(Class<OmdbTvShowDTO> t) {
        super(t);
    }

    @Override
    public OmdbTvShowDTO deserialize(JsonParser jp, DeserializationContext dc) throws IOException {
        ...
        return new OmdbTvShowDTO(name, year, description, imdbRating, length, actors, directors, country, poster, production, genre);
    }
}
